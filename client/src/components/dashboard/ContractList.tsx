						...
						<div className="flex items-center gap-3">
							...
							<div>
								...
								<p className="text-[10px] text-slate-400 font-bold uppercase tracking-wider">
									{contract.room?.building?.name || "Tòa nhà"}
								</p>
							</div>
						</div>
						<div
							className={`px-4 py-1.5 rounded-xl text-[10px] font-black uppercase tracking-widest border transition-colors ${
								contract.status === "active" ?
									"bg-linear-to-br from-brand-primary/10 to-brand-primary/5 text-brand-primary border-brand-primary/20"
					...
					<div className="space-y-4 mb-8">
						<div className="flex items-center gap-3">
							...
							<div className="min-w-0">
								<p className="text-[10px] text-slate-300 font-black uppercase tracking-widest leading-none mb-1">
									Người thuê
								</p>
						...
						<div className="grid grid-cols-2 gap-4 pt-2 border-t border-slate-50">
							<div>
								...
								<p className="text-lg font-black text-slate-900">
									{(contract.rent_amount / 1000000).toFixed(1)}M
								</p>
							</div>
							<div>
								<p className="text-[10px] text-slate-300 font-black uppercase tracking-widest mb-1">
								...
								<p className="text-lg font-black text-brand-primary">
									{(contract.deposit_amount / 1000000).toFixed(1)}M
								</p>
							</div>
						</div>
					</div>
