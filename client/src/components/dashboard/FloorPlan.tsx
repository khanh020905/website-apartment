									...
									{floorGroups[floor]
										...
										.map((room) => {
											...
											return (
												...
												>
													<div
														className={`aspect-5/4 ${cfg.bg} border-2 ${cfg.border} rounded-3xl p-4 flex flex-col items-center justify-center gap-1.5 transition-all hover:shadow-xl hover:-translate-y-1 cursor-pointer overflow-hidden relative`}
													>
					...
					>
						<div
							className={`w-3 h-3 rounded-full ${
								cfg.bg.replace("bg-", "bg-").split("-")[1] === "slate" ? "bg-slate-400"
								: cfg.bg.replace("bg-", "bg-").split("-")[1] === "emerald" ? "bg-emerald-500"
								: "bg-orange-500"
							}`}
						/>
