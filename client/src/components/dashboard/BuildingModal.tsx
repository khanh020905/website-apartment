...
export const BuildingModal = ({ isOpen, onClose, onSave, initialData }: BuildingModalProps) => {
		...
		<div className="fixed inset-0 z-100 flex items-center justify-center p-4">
			...
			>
				...
				<div className="p-8 border-b border-slate-50 flex items-center justify-between bg-slate-50/50">
					<div>
						...
						<p className="text-xs font-bold text-slate-400 uppercase tracking-widest mt-1">
							Cấu hình thông tin cơ bản cho tòa nhà quản lý
						</p>
					</div>
					<button
						onClick={onClose}
				...
				<div className="p-8 border-t border-slate-50 flex gap-4 bg-slate-50/20">
					...
					<button
						onClick={handleSave}
						className="flex-1 h-14 rounded-2xl bg-brand-primary text-white font-black text-xs uppercase tracking-widest shadow-xl shadow-brand-primary/20 hover:bg-brand-dark transition-colors cursor-pointer"
					>
