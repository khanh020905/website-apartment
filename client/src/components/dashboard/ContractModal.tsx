          ...
          <div className="p-8 border-b border-slate-50 flex items-center justify-between bg-linear-to-r from-brand-primary/5 to-transparent">
            <div>
              <div className="flex items-center gap-2 mb-1">
                ...
                <span className="text-[10px] font-black uppercase tracking-widest text-brand-primary/60">Rental Agreement</span>
              </div>
            ...
            <button onClick={onClose} className="p-3 hover:bg-brand-primary/5 rounded-2xl transition-colors cursor-pointer">
