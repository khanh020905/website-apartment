...
import { User, Phone, Mail, Calendar, Wallet, FileText, Building2 } from 'lucide-react';
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      <div className="p-4 bg-amber-50 rounded-2xl border border-amber-100 flex items-center gap-3">
        ...
        <div>
          <p className="text-[10px] font-black uppercase tracking-widest text-amber-600/60 leading-none mb-1">Đang đặt cho phòng</p>
