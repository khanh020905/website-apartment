...
import { Wrench, Calendar, Upload } from "lucide-react";
      ...
      <div className="flex-1 overflow-y-auto p-6 space-y-6 scrollbar-thin scrollbar-thumb-slate-200">
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div className="space-y-1.5">
            ...
            <button type="button" className="w-full flex items-center gap-2 px-4 py-2.5 bg-white border border-slate-200 rounded-xl text-sm hover:bg-slate-50 hover:border-slate-300 transition-colors">
        ...
        <div className="space-y-1.5">
           ...
           <div className="border-2 border-dashed border-slate-200 rounded-2xl p-6 flex flex-col items-center justify-center hover:bg-slate-50 hover:border-amber-400 transition-colors cursor-pointer group">
               ...
               <p className="text-[13px] font-medium text-slate-600 mb-1">Tải lên hình ảnh hoặc video.</p>
