			...
			<div className="flex-1 overflow-y-auto p-6 space-y-6 scrollbar-thin scrollbar-thumb-slate-200">
				...
				<div className="space-y-1.5 pt-2">
					...
					<p className="text-[12px] text-slate-500 mt-2 flex items-start gap-1">
						<span className="w-3.5 h-3.5 rounded-full border border-slate-400 flex items-center justify-center text-[8px] mt-0.5">
							i
						</span>
						Người đảm nhận mặc định là người được tự động chọn đảm nhận cho loại sự cố này khi có sự
						cố mới được tạo.
					</p>
				</div>

				<div className="space-y-1.5 pt-2">
					<label className="text-[13px] font-semibold text-slate-700">Mô tả</label>
