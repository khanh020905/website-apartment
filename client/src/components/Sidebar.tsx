...
const Sidebar = ({ listings, onFilterChange }: SidebarProps) => {
  ...
  return (
    <motion.div
      ...
      className="w-[450px] min-w-[450px] h-full bg-white border-r border-slate-200 flex flex-col overflow-hidden"
    >
      {/* Filters */}
      <div className="px-5 pt-5 pb-4 border-b border-slate-100 flex-shrink-0">
        ...
        <div className="mb-5">
          ...
          <div className="relative">
            <input
              ...
              className="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-full text-sm text-slate-700 placeholder-slate-400 focus:outline-none focus:border-emerald-600 focus:ring-2 focus:ring-emerald-700/10 transition-all"
            />
        ...
        <div>
          ...
          <div className="flex items-center justify-between mb-3">
            <span className="text-xs font-bold text-white bg-emerald-800 px-3 py-1 rounded-full shadow-sm">
          ...
          <div className="relative h-6 flex items-center">
            ...
            <div
              className="absolute h-[6px] bg-emerald-700 rounded-full"
          ...
          <div className="flex gap-3 mt-3">
            <div className="flex-1 flex items-center bg-white border border-slate-200 rounded-lg overflow-hidden focus-within:border-emerald-400 transition-colors">
              <input
                type="number"
                value={budgetMin}
                onChange={(e) => handleMinChange(Number(e.target.value))}
      ...
      <div className="flex-1 overflow-y-auto px-5 pt-4 pb-6">
        <div className="flex items-center justify-between mb-4">
          ...
          <span className="text-xs text-emerald-800 font-semibold bg-emerald-50 px-2.5 py-1 rounded-full">
