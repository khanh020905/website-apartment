	...
	const filterCategories: FilterCategory[] = [
		{
			...
			tags: [
				...
				{ label: "Không nội thất", icon: X, type: "furniture", value: "none" },
				{
					...
					icon: Layers,
					type: "amenity",
					value: amenities.find((a) => a.name_vi === "Gác lửng")?.id || "Gác lửng",
				},
				{
					label: "Duplex",
					icon: Columns,
					type: "amenity",
					value: amenities.find((a) => a.name_vi === "Duplex")?.id || "Duplex",
				},
				{
					label: "Phòng Studio",
					icon: Layout,
					type: "amenity",
					value: amenities.find((a) => a.name_vi === "Phòng Studio")?.id || "Phòng Studio",
				},
				{
					label: "Ban công",
					icon: Maximize,
					type: "amenity",
					value: amenities.find((a) => a.name_vi === "Ban công")?.id || "Ban công",
				},
				{
					label: "Sleep box",
					icon: Bed,
					type: "amenity",
					value: amenities.find((a) => a.name_vi === "Sleep box")?.id || "Sleep box",
				},
				{
					label: "Tách bếp",
					icon: Microwave,
					type: "amenity",
					value: amenities.find((a) => a.name_vi === "Tách bếp")?.id || "Tách bếp",
				},
				{
					label: "Cửa sổ trời",
					icon: Sun,
					type: "amenity",
					value: amenities.find((a) => a.name_vi === "Cửa sổ trời")?.id || "Cửa sổ trời",
				},
				{ label: "1 Phòng Ngủ", icon: Bed, type: "bedrooms", value: 1 },
				{
					...
					icon: Layout,
					type: "amenity",
					value: amenities.find((a) => a.name_vi === "Mặt bằng")?.id || "Mặt bằng",
				},
			...
			tags: [
				{
					...
					icon: Wind,
					type: "amenity",
					value: amenities.find((a) => a.name_vi === "Máy lạnh")?.id || "Máy lạnh",
				},
				{
					label: "Tủ lạnh",
					icon: Refrigerator,
					type: "amenity",
					value: amenities.find((a) => a.name_vi === "Tủ lạnh")?.id || "Tủ lạnh",
				},
				{
					label: "Máy giặt",
					icon: WashingMachine,
					type: "amenity",
					value: amenities.find((a) => a.name_vi === "Máy giặt")?.id || "Máy giặt",
				},
				{
					label: "Tủ quần áo",
					icon: Briefcase,
					type: "amenity",
					value: amenities.find((a) => a.name_vi === "Tủ quần áo")?.id || "Tủ quần áo",
				},
				{
					label: "Máy nước nóng",
					icon: Zap,
					type: "amenity",
					value: amenities.find((a) => a.name_vi === "Máy nước nóng")?.id || "Máy nước nóng",
				},
				{
					label: "Kệ bếp",
					icon: UtensilsCrossed,
					type: "amenity",
					value: amenities.find((a) => a.name_vi === "Kệ bếp")?.id || "Kệ bếp",
				},
			],
		},
		{
			...
			tags: [
				{
					...
					icon: Layers,
					type: "amenity",
					value: amenities.find((a) => a.name_vi === "Có thang máy")?.id || "Có thang máy",
				},
				{
					label: "Giữ xe máy",
					icon: Bike,
					type: "amenity",
					value: amenities.find((a) => a.name_vi === "Giữ xe máy")?.id || "Giữ xe máy",
				},
				{
					label: "Giữ xe điện",
					icon: Bike,
					type: "amenity",
					value: amenities.find((a) => a.name_vi === "Giữ xe điện")?.id || "Giữ xe điện",
				},
				{
					label: "Đậu xe ô tô",
					icon: Car,
					type: "amenity",
					value: amenities.find((a) => a.name_vi === "Đậu xe ô tô")?.id || "Đậu xe ô tô",
				},
				{
					label: "Nuôi thú cưng",
					icon: PawPrint,
					type: "amenity",
					value: amenities.find((a) => a.name_vi === "Nuôi thú cưng")?.id || "Nuôi thú cưng",
				},
				{
					label: "Bảo vệ 24/24",
					icon: ShieldCheck,
					type: "amenity",
					value: amenities.find((a) => a.name_vi === "Bảo vệ 24/24")?.id || "Bảo vệ 24/24",
				},
				{
					label: "Nhận khách nước ngoài",
					icon: Globe,
					type: "amenity",
					value:
						amenities.find((a) => a.name_vi === "Nhận khách nước ngoài")?.id ||
	...
	const filteredListings = useMemo(() => {
		const filtered = listings.filter((l) => {
			...
			const matchFurniture =
				!appliedOtherFilters.furniture || l.furniture === appliedOtherFilters.furniture;
			const matchBedrooms =
				!appliedOtherFilters.bedrooms || l.bedrooms === appliedOtherFilters.bedrooms;
