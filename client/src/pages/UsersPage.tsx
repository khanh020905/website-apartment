      ...
      <div className="flex-1 overflow-auto p-6 space-y-4">
        ...
        <div className="flex flex-wrap items-center gap-3">
           <div className="relative flex-1 min-w-[200px]">
              ...
              <input type="text" placeholder="Tên" className="w-full pl-10 pr-4 h-10 bg-white border border-slate-200 rounded-lg text-[13px] font-bold text-slate-700 outline-none focus:border-amber-400 shadow-sm" />
           </div>
           <input type="text" placeholder="Email" className="w-[180px] px-3 h-10 bg-white border border-slate-200 rounded-lg text-[13px] font-bold text-slate-700 outline-none focus:border-amber-400 shadow-sm" />
           
           <div className="w-[180px] relative group">
              <select className="w-full pl-3 pr-8 h-10 bg-white border border-slate-200 rounded-lg text-[13px] font-bold text-slate-700 outline-none appearance-none focus:border-amber-400 shadow-sm cursor-pointer">
           ...
           <button className="h-10 px-5 bg-amber-400 text-slate-900 rounded-lg text-[13px] font-black hover:bg-amber-500 transition-colors shadow-sm cursor-pointer flex items-center gap-2">
           ...
           <button 
             ...
             className="h-10 px-5 bg-amber-400 text-slate-900 rounded-lg text-[13px] font-black hover:bg-amber-500 transition-colors shadow-sm ml-auto flex items-center gap-1.5 cursor-pointer"
           >
        ...
        <div className="bg-white border border-slate-200 rounded-xl overflow-hidden shadow-sm">
           <div className="overflow-x-auto">
              <table className="w-full text-left">
                 ...
                 <tbody className="divide-y divide-slate-100">
                    {USERS.map((user) => (
                       <tr key={user.id} className="hover:bg-amber-50/10 transition-colors group">
                          ...
                          <td className="px-5 py-3">
                             <div className={`w-10 h-5 rounded-full relative transition-colors cursor-pointer ${user.status === 'locked' ? 'bg-amber-400' : 'bg-slate-200'}`}>
           ...
           <div className="px-5 py-3 bg-[#fefefe] border-t border-slate-50 flex items-center justify-between">
              ...
              <div className="flex items-center gap-1">
                 ...
                 <button className="w-8 h-8 flex items-center justify-center rounded bg-amber-400 text-white text-[13px] font-bold">1</button>
                 <button className="w-8 h-8 flex items-center justify-center rounded border border-slate-200 text-slate-300">⟩</button>
              </div>
           </div>
        </div>
            ...
            <>
               ...
               <motion.div initial={{ x: "100%" }} animate={{ x: 0 }} exit={{ x: "100%" }} transition={{ type: "spring", damping: 30, stiffness: 300 }} className="absolute top-0 right-0 w-full max-w-[480px] h-full bg-white shadow-2xl z-50 flex flex-col font-['Plus_Jakarta_Sans',sans-serif]">
                  ...
                  <div className="flex-1 overflow-y-auto p-6 space-y-6 pb-24">
                     <div className="flex flex-col items-center gap-3">
                        <div className="w-24 h-24 rounded-full bg-slate-50 border-2 border-dashed border-slate-200 flex items-center justify-center relative cursor-pointer hover:bg-slate-100 transition-colors">
                           ...
                           <div className="absolute bottom-0 right-0 bg-white p-1.5 rounded-full shadow-lg border border-slate-100 text-amber-500"><Plus className="w-3.5 h-3.5 font-black" /></div>
                        </div>
                     ...
                     <div className="grid grid-cols-1 gap-5">
                        <div className="space-y-1.5">
                           ...
                           <select className="w-full px-4 h-11 border border-slate-200 rounded-lg text-sm font-bold text-slate-800 focus:border-amber-400 outline-none appearance-none bg-white">
                              <option>Chọn vai trò</option>
                           </select>
                        </div>
                        <div className="space-y-1.5">
                           <label className="text-[13px] font-black text-slate-700 uppercase">Tên đầy đủ</label>
                           <input type="text" placeholder="Nhập tên đầy đủ" className="w-full px-4 h-11 border border-slate-200 rounded-lg text-sm font-bold text-slate-800 focus:border-amber-400 outline-none" />
                        </div>
                        <div className="space-y-1.5">
                           <label className="text-[13px] font-black text-slate-700 uppercase">Email</label>
                           <input type="email" placeholder="Nhập email" className="w-full px-4 h-11 border border-slate-200 rounded-lg text-sm font-bold text-slate-800 focus:border-amber-400 outline-none" />
                        </div>
                        <div className="space-y-1.5">
                           <label className="text-[13px] font-black text-slate-700 uppercase">Số điện thoại</label>
                           <input type="text" placeholder="Nhập số điện thoại" className="w-full px-4 h-11 border border-slate-200 rounded-lg text-sm font-bold text-slate-800 focus:border-amber-400 outline-none" />
                        </div>
                        <div className="space-y-1.5">
                  ...
                  <div className="absolute bottom-0 left-0 w-full p-5 border-t border-slate-50 bg-white flex items-center justify-end gap-3 shadow-[0_-4px_10px_rgba(0,0,0,0.02)]">
                     ...
                     <button className="px-8 h-11 text-sm font-black bg-amber-400 text-slate-900 rounded-lg shadow-md hover:bg-amber-500 hover:shadow-lg transition-all">Xác nhận</button>
                  </div>
               </motion.div>
            </>
         )}
