							...
							<SectionCard title="Mạng xã hội">
								<div className="space-y-2">
									{[
										...
										<button
											key={i}
											className="w-full flex items-center gap-2 px-3 py-2 border border-dashed border-slate-200 rounded-xl text-sm text-slate-400 hover:border-brand-primary/30 hover:text-brand-primary hover:bg-brand-primary/5 transition-all"
										>
								...
								<div>
									...
									<div className="grid grid-cols-2 gap-3">
										{["Logo kích cỡ đầy đủ", "Logo thu gọn"].map((label) => (
											<div
												key={label}
												className="aspect-video border-2 border-dashed border-slate-200 rounded-xl flex flex-col items-center justify-center gap-2 hover:border-brand-primary/40 hover:bg-brand-primary/5 transition-all cursor-pointer"
											>
						...
						<SectionCard title="Cài đặt thanh toán">
							<div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
								...
								<div className="space-y-3">
									{[
										{
											label: "Nhắc nhở hết hạn visa",
											desc: "Hệ thống gửi thông báo trước khi visa hết hạn",
											icon: Shield,
										},
										{
											label: "Chính sách khách hàng",
											desc: "Điều khoản và quy định với khách thuê",
											icon: Settings,
										},
									].map((s, i) => (
										<div
