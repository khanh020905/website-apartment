		...
		<div className="flex-1 overflow-y-auto bg-slate-50">
			...
			>
				...
				<div
					...
					style={{
						background:
							"linear-gradient(135deg, rgba(2,44,34,0.92) 0%, rgba(6,78,59,0.88) 50%, rgba(6,95,70,0.85) 100%)",
					}}
				/>
				...
				<p className="text-white/70 text-sm max-w-md mx-auto leading-relaxed relative z-10">
					Có câu hỏi về dịch vụ cho thuê bất động sản? Đội ngũ HomeSpot luôn sẵn sàng hỗ trợ bạn
					24/7
				</p>
			</motion.div>
							...
							<form className="flex flex-col gap-5">
								...
								<div>
									...
									<textarea
										...
										className="w-full px-4 py-3 border border-slate-200 rounded-xl text-sm text-slate-700 placeholder-slate-400 focus:outline-none focus:border-teal-600 focus:ring-2 focus:ring-teal-700/10 transition-all resize-none"
									/>
								</div>
								<motion.button
			...
			>
				<div className="flex gap-12 flex-col lg:flex-row">
					...
					<div className="lg:w-95 shrink-0 flex flex-col justify-between">
						<div>
						...
						>
							...
							<p className="text-white/70 text-xs leading-relaxed mb-4">
								Không tìm thấy câu trả lời? Gửi email cho chúng tôi và chúng tôi sẽ phản hồi sớm
								nhất!
							</p>
							<a
						...
						{faqs.map((faq, i) => (
							<motion.div
								...
								className={`bg-white rounded-2xl border transition-all duration-300 ${
									openFaq === i ?
										"border-teal-200 shadow-md shadow-teal-100/50"
