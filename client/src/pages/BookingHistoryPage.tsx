							...
							<div className="flex-1 overflow-y-auto p-5 space-y-6">
								...
								<div>
									...
									<div className="flex items-center border border-slate-200 rounded-lg px-3 hover:border-slate-300 transition-colors">
										<input
											type="text"
											placeholder="Từ ngày"
											className="w-full py-2.5 text-sm outline-none text-slate-600"
										/>
								...
								<div className="flex items-center justify-between pt-2">
									<span className="text-sm font-semibold text-slate-800">
										Chỉ hiển thị đặt phòng áp dụng thuế
									</span>
									<button
									...
									>
										<span
											className={`absolute top-1 w-4 h-4 rounded-full bg-white transition-all shadow-sm ${taxOnly ? "left-6" : "left-1"}`}
										/>
									</button>
								</div>
							</div>
