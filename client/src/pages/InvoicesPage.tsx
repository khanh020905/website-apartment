			...
			<div className="flex-1 overflow-auto bg-[#f8f9fa] p-5 lg:p-6 flex flex-col gap-6">
				...
				<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 shrink-0">
					{statCards.map((stat, i) => (
						...
						>
							<div
								className={`w-12 h-12 rounded-xl flex items-center justify-center shrink-0 ${stat.iconBg} transition-transform group-hover:scale-110`}
							>
							...
							<tbody className="divide-y divide-slate-100">
								{loading ?
									<tr>
										<td
											colSpan={13}
											className="px-6 py-20 text-center bg-white cursor-default"
										>
								...
								:	invoices.map((inv) => (
										...
										>
											...
											<td className="px-5 py-3.5">
												<span className="font-mono text-[13px] font-bold text-blue-600 truncate">
													{inv.code}
												</span>
											</td>
											<td className="px-5 py-3.5">
											...
											<td className="px-5 py-3.5">
												<span
													className={`inline-flex px-2 py-0.5 rounded-md text-[11px] font-bold uppercase tracking-wide ${STATUS_COLORS[inv.status]}`}
												>
											...
											<td className="px-5 py-3.5 text-[13px] text-slate-500">—</td>
											<td className="px-5 py-3.5 text-[13px] text-slate-600 font-medium">
												{inv.customer_name || "—"}
											</td>
											<td className="px-5 py-3.5">
												<span
													className={`text-[12px] font-bold ${inv.has_vat ? "text-emerald-600" : "text-slate-400"}`}
												>
											...
											<td className="px-5 py-3.5 text-right">
												<div className="flex items-center justify-end gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
													<button className="text-blue-600 hover:underline text-[12px] font-semibold">
														Chi tiết
													</button>
												</div>
											</td>
						...
						>
							...
							<div className="flex-1 overflow-y-auto p-5 space-y-6">
								...
								<div>
									...
									<input
										type="month"
										className="w-full px-3 py-2 border border-slate-200 rounded-lg text-[13px] font-medium text-slate-900 focus:outline-none focus:border-amber-400"
									/>
								</div>
