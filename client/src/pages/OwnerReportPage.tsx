    ...
    <div className="flex-1 flex flex-col h-full bg-[#f8f9fa] relative overflow-hidden">
      ...
      <div className="bg-white border-b border-slate-200">
        <div className="px-6 py-4">
          <h1 className="text-[20px] font-bold text-slate-900 tracking-tight">Theo dõi thu tiền tháng</h1>
        </div>
      ...
      <div className="flex-1 overflow-auto bg-[#f8f9fa] p-5 lg:p-6 flex flex-col gap-6">
        ...
        <div className="text-[13px] text-slate-500 font-medium">
          Cập nhật lần cuối lúc: 07/04/2026 03:20 <RefreshCw className="w-3 h-3 inline-block ml-1 cursor-pointer hover:text-slate-900" />
        </div>
           ...
           <div className="overflow-x-auto flex-1">
              <table className="w-full text-left">
                <thead className="bg-[#f8f9fa] border-b border-slate-200">
                  <tr>
                    {["Toà nhà", "Phòng", "Tiền phòng", "Nợ cũ", "Tiền cọc", "Tiền phát sinh", "Khuyến mãi", "Thanh toán cho chủ nhà", "Smartos đã thu", "Smartos chưa thu"].map((h, i) => (
                ...
                <tbody>
                   <tr>
                      <td colSpan={10} className="text-center py-12 text-[13px] font-medium text-slate-500">
                         Không có dữ liệu
                      </td>
                   </tr>
                </tbody>
