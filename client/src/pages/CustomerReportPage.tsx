    ...
    <div className="flex-1 flex flex-col h-full bg-[#f8f9fa] relative overflow-hidden">
      ...
      <div className="bg-white border-b border-slate-200">
        <div className="px-6 py-4">
          <h1 className="text-[20px] font-bold text-slate-900 tracking-tight">Báo cáo khách hàng</h1>
        </div>
        <div className="px-6 flex items-center justify-between border-t border-slate-100 py-3">
          <div className="flex gap-6">
            <button className="text-[14px] font-bold text-amber-600 border-b-2 border-amber-500 pb-3 -mb-3">Quản lý nợ</button>
          </div>
      ...
      <div className="flex-1 overflow-auto bg-[#f8f9fa] p-5 lg:p-6 flex flex-col gap-6">
        ...
        <div className="text-[13px] text-slate-500 font-medium">
          Cập nhật lần cuối lúc: 07/04/2026 03:10 <RefreshCw className="w-3 h-3 inline-block ml-1 cursor-pointer hover:text-slate-900" />
        </div>
        ...
        <div className="bg-white p-5 lg:p-6 rounded-xl border border-slate-200 shadow-sm flex flex-col flex-1 min-h-[400px]">
           <div className="flex items-center justify-between mb-4">
              <h3 className="text-[15px] font-bold text-slate-900">Chi tiết thanh toán của khách hàng</h3>
           </div>
           {/* Table filters */}
           <div className="flex flex-wrap items-center gap-3 mb-4">
              <input type="text" placeholder="Tìm kiếm" className="px-3 py-1.5 border border-slate-200 rounded-lg text-[13px] outline-none focus:border-amber-400 w-64" />
           ...
           <div className="overflow-x-auto flex-1">
              <table className="w-full text-left">
                <thead className="bg-[#f8f9fa] border-y border-slate-200">
                  <tr>
                    {["Khách hàng", "Toà nhà", "Phòng", "Mã hóa đơn", "Trạng thái", "Tổng tiền", "Tiền đã thanh toán", "Tiền chưa thanh toán"].map((h, i) => (
                      <th key={i} className="px-4 py-3 text-[12px] font-bold text-slate-600 tracking-wide whitespace-nowrap">
                        {h}
                      </th>
                    ))}
                  </tr>
                ...
                <tbody>
                   <tr>
                      <td colSpan={8} className="text-center py-12 text-[13px] font-medium text-slate-500">
                         Không có dữ liệu
                      </td>
                   </tr>
                </tbody>
