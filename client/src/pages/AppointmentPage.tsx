            ...
            <table className="w-full">
              <thead className="bg-[#f8f9fa] border-b border-slate-200">
                <tr>
                  ...
                  {["Mã xem phòng", "Khách xem phòng", "Thời gian", "Phòng", "Toà nhà", "Trạng thái", "Yêu cầu đặt phòng", "Người đảm nhận"].map((h, i) => (
            ...
            >
              ...
              <div className="flex-1 overflow-y-auto p-5 space-y-6">
                <div>
                  ...
                  <p className="text-sm text-slate-500">Các filters bổ sung (mocked for Lịch hẹn)</p>
                </div>
              </div>
