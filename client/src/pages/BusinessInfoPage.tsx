    ...
    <div className="flex-1 flex flex-col h-full bg-[#f8f9fa] relative overflow-hidden">
      ...
      <div className="bg-white border-b border-slate-200">
        <div className="px-6 py-4 flex items-center justify-between">
          <h1 className="text-[20px] font-bold text-slate-900 tracking-tight">Thông tin doanh nghiệp</h1>
          ...
          <div className="lg:col-span-2 space-y-6">
             ...
             <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                   <div className="space-y-2">
                      <label className="text-[13px] font-bold text-slate-700">Tên doanh nghiệp <span className="text-rose-500">*</span></label>
                      <input 
                        name="name"
                        type="text" 
                        value={formData.name}
             ...
             <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                   ...
                   <div className="space-y-2">
                      <label className="text-[13px] font-bold text-slate-700">Email nhận thông báo</label>
                      <div className="relative">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                   ...
                   <div className="space-y-2">
                      ...
                      >
                        ...
                        <option value="(GMT+08:00) Singapore, Taipei, Beijing">(GMT+08:00) Singapore, Taipei, Beijing</option>
                      </select>
                   </div>
                </div>
             </div>
          ...
          <div className="space-y-6">
             ...
             <div className="bg-emerald-50 p-6 rounded-xl border border-emerald-100 space-y-4">
                <div className="flex items-center gap-3">
                   ...
                   <div>
                      <h4 className="text-[13px] font-bold text-emerald-900 tracking-tight">Tài khoản chính thức</h4>
                      <p className="text-[10px] uppercase font-black text-emerald-600/70 tracking-widest mt-0.5">Verified Business</p>
                   </div>
                </div>
