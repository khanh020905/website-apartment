...
const TransactionConfigPage = () => {
	...
	const MOCK_BANKS = [
		...
		},
		{
			id: "2",
			bank: "Techcombank",
			name: "CÔNG TY SMARTOS",
			account: "190333444555",
			branch: "TTGD Miền Nam",
			status: "active",
		},
	];
							...
							>
									...
									<div className="flex items-center gap-4">
										...
										<div>
											...
											<p className="text-[12px] text-slate-500 font-medium">
												Sử dụng để tạo mã QR thanh toán tự động cho cư dân
											</p>
										</div>
									</div>
								...
								<div className="grid grid-cols-1 md:grid-cols-2 gap-6">
									{MOCK_BANKS.map((bank) => (
										<div
											key={bank.id}
											className="bg-white p-5 rounded-2xl border border-slate-200 shadow-sm hover:shadow-md transition-all group relative overflow-hidden cursor-pointer"
										>
							...
							>
								...
								<div>
									...
									<p className="text-[13px] text-slate-500 font-medium max-w-sm mt-1">
										Chúng tôi đang làm việc để sớm mang đến khả năng kết nối cổng thanh toán VNPay,
										MoMo và nhiều phương thức khác.
									</p>
								</div>
