										...
										.map((room) => (
											...
											>
												<div className="flex justify-between items-start mb-2">
													...
													:	<span className="text-[9px] bg-brand-bg text-brand-ink font-bold px-1.5 py-0.5 rounded uppercase">
															Thiếu ảnh
														</span>
													}
												</div>
				...
				{step === 4 && (
					...
					>
						<div className="bg-white rounded-3xl p-8 border border-slate-100 shadow-sm space-y-6">
							...
							:	<div className="aspect-21/9 rounded-2xl bg-brand-bg text-brand-dark border border-brand-primary/20 flex flex-col items-center justify-center font-bold">
