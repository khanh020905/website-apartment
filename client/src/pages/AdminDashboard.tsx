	...
	maintenance: (
		...
		>
			<path
				strokeLinecap="round"
				strokeLinejoin="round"
				d="M11.42 15.17l-5.658.002A.5.5 0 015 14.67V9.33a.5.5 0 01.762-.426l5.658 3.34a.5.5 0 010 .852zM14.25 7.5h-.096c-1.088 0-2.04.711-2.353 1.75l-1.052 3.5c-.313 1.039-1.265 1.75-2.353 1.75H8.25m13.148-5.134a.5.5 0 01.502.86l-5.647 3.289a.5.5 0 01-.502-.86l5.647-3.289z"
			/>
		</svg>
	),
	report: (
...
const overdueInvoices = [
	{
		id: "INV0052",
		room: "P102",
		building: "Trương Quyền",
		tenant: "Huỳnh Minh Huy",
		phone: "038590785",
		date: "03/02/2024",
		amount: 4044000,
...
function EmptyState({ title, description }: { title: string; description: string }) {
	return (
		<div className="flex flex-col items-center justify-center py-10">
			...
			<p className="text-sm text-slate-400 text-center max-w-70">{description}</p>
		</div>
	);
}
	...
	return (
		<div className="flex-1 flex overflow-hidden bg-slate-50">
			...
			<motion.aside
				...
				className={`${sidebarCollapsed ? "w-17" : "w-55"} bg-white border-r border-slate-100 flex flex-col h-full transition-all duration-300 shrink-0`}
			>
			...
			>
				<div className="sticky top-0 z-10 bg-white border-b border-slate-200 px-4 py-2.5 flex items-center gap-3">
					<select className="text-sm bg-white border border-slate-200 rounded-lg px-3 py-2 text-slate-700 min-w-40 cursor-pointer">
				...
				<div className="p-8 space-y-8 max-w-300">
							...
							icon={
								...
								>
									<path
										strokeLinecap="round"
										strokeLinejoin="round"
										d="M15 9h3.75M15 12h3.75M15 15h3.75M4.5 19.5h15a2.25 2.25 0 002.25-2.25V6.75A2.25 2.25 0 0019.5 4.5H4.5a2.25 2.25 0 00-2.25 2.25v10.5A2.25 2.25 0 004.5 19.5zm6-10.125a1.875 1.875 0 11-3.75 0 1.875 1.875 0 013.75 0zm1.294 6.336a6.721 6.721 0 01-3.17.789 6.721 6.721 0 01-3.168-.789 3.376 3.376 0 016.338 0z"
									/>
								</svg>
							}
							iconBg="bg-purple-50"
					...
					<div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
						<div className="bg-white rounded-2xl border border-slate-100 p-6 shadow-sm">
							...
							<EmptyState
								...
								description="Không có hóa đơn nào cần tạo ngay lúc này."
							/>
						</div>
						...
						<div className="bg-white rounded-2xl border border-slate-100 p-6 shadow-sm">
							...
							<EmptyState
								title="Lịch trống"
								description="Hôm nay chưa có yêu cầu xem phòng nào."
							/>
						</div>
					</div>
					...
					<div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
						<div className="bg-white rounded-2xl border border-slate-100 p-6 shadow-sm">
							...
							<EmptyState
								title="Yên bình"
								description="Chưa có báo cáo sự cố nào từ cư dân."
							/>
						</div>
						...
						<div className="bg-white rounded-2xl border border-slate-100 p-6 shadow-sm">
							...
							<div className="space-y-4">
								{overdueInvoices.map((inv) => (
									<div
										key={inv.id}
										className="group border border-slate-50 rounded-2xl p-4 hover:bg-slate-50 transition-all hover:border-emerald-100"
									>
										<div className="flex items-center justify-between mb-3">
											<div className="flex items-center gap-2">
												<span className="text-sm font-black text-emerald-600">#{inv.id}</span>
												<span className="px-2 py-0.5 bg-slate-100 rounded-lg text-[10px] font-black text-slate-500 uppercase">
													{inv.room}
												</span>
											</div>
					...
					<div className="text-center py-10">
						<p className="text-[10px] font-black uppercase tracking-[0.2em] text-slate-300">
							Smartos Property Management &copy; 2026
						</p>
					</div>
				</div>
			</motion.main>
