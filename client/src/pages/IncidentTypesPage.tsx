...
const MOCK_TYPES: IncidentType[] = [
  ...
  { id: "2", name: "Nội thất & Thiết bị", icon: "🛋️", status: "active", assignee: "Kỹ thuật viên 1" },
          ...
          <div className="overflow-x-auto flex-1">
            <table className="w-full h-full text-left">
              <thead className="bg-[#f8f9fa] border-b border-slate-200 sticky top-0 z-10">
                <tr>
                  {[
                    "Biểu tượng", "Tên", "Người đảm nhận mặc định", "Trạng thái"
                  ].map((h, i) => (
              ...
              <tbody className="divide-y divide-slate-100">
                {filteredData.length === 0 ? (
                  <tr>
                    <td colSpan={3} className="px-6 py-28 text-center bg-white cursor-default">
