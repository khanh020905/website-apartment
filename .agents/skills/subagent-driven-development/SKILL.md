...
### Step 1: Read plan, extract all tasks with full text, note context, create TodoWrite

### Per Task Loop:
1. Dispatch implementer subagent with full task text + context
2. If implementer asks questions → Answer clearly and completely, re-dispatch
3. Implementer implements, tests, commits, self-reviews
4. Dispatch spec compliance reviewer
5. If spec issues found → implementer fixes → re-review until approved
